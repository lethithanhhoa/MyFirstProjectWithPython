 ...
 * @author Hoa Le
 */
public class ModifyWordJFrame extends javax.swing.JFrame {

    /**
     * Creates new form ModifyWordJFrame
     */
    public ModifyWordJFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("New Difinition");
    ...
    //bat suw ken cho nut Ok   ->>>>> cai nay k xoa tu, xoa cai tu sau khi minh sua
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        
        BackEnd.Main.ev.modifyWord(jTextField1.getText(), jTextField2.getText(), jTextField3.getText());
        JOptionPane.showMessageDialog(rootPane, "Ban da sua thanh cong");
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModifyWordJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
